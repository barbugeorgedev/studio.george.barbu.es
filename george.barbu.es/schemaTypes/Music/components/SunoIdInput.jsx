...
export default function SunoIdInput(props) {
  const {value, renderDefault} = props
  const sunoUrl = value ? `https://suno.com/song/${value}` : null

  // Render the default input and wrap it with our button
  const inputElement = renderDefault(props)
  
  // Extract the input element from the rendered component
  // We'll need to wrap it in a container with the button
  return (
